            ...
            <? if (count($arResult["GRID"]["ROWS"]) > 0) { ?>
                ...
                <div class="basket_main_opt">
                    ...
                    */
                    ...
                    foreach ($arResult['OFFERS'] as $key1 => $arItem) {
                        $file = CFile::ResizeImageGet($arResult['MAIN_ITEM'][$key1]['PREVIEW_PICTURE'], [
                            'width' => 100,
                            'height' => 150
                        ], BX_RESIZE_IMAGE_PROPORTIONAL, true);
                        $full_summ_offer = 0;
                        $full_quantity_offer = 0;
                        ?>
                            ...
                            <div class="info_store_left">
                                <div class="top_item_name">
                                    <? if ($arResult['OfferPrice94'][$key1]) {
                                        ?>
                                        <div class="tin tin_1" data-price="<?= $arResult['OfferPrice95'][$key1] ?>">
                                            Базовая:
                                            <br> <?= number_format($arResult['OfferPrice95'][$key1], 0, ' ', ' ') ?>руб.
                                        </div>
                                    <? } ?>
					...
					<? echo number_format(round($arResult['OfferPrice95'][$key1] - calc_percent($arResult['OfferPrice95'][$key1], $first_discount) - calc_percent($arResult['OfferPrice95'][$key1], $curent_discount_percend) - calc_percent($arResult['OfferPrice95'][$key1], $Discount)), 0, ' ', ' '); ?> руб.
                                    ...
                                    <? if ($arResult['OfferPrice94'][$key1]) {
                                        ?>
                                        <div class="tin tin_3">РРЦ:
                                            <br> <?= number_format($arResult['OfferPrice94'][$key1], 0, ' ', ' ') ?>руб.
                                        </div>
                                    <? } ?>
                                </div>
                                <div class="aimg" href="<?= $arResult['MAIN_ITEM'][$key1]['DETAIL_PAGE_URL'] ?>">
                                    <img src="<?= $file['src'] ?>" alt="<?= $arResult['MAIN_ITEM'][$key1]['NAME'] ?>"
                                         class="inform-catalog-page__goods-image">
                            ...
                            <div class="info_store_right">
                                <div class="aimg aimg_mob">
                                    <? foreach ($arItem as $key3 => $offer) {
                                        ?>
                                        <div class="opt_offer_item opt_offer_item_bg opt_offer_item_mob"
                                             data-id="<?= $key3 ?>">
                                            <div class="item_size"><?= $offer['NAME'] ?></div>
                                        </div>
                                    <? } ?>
...
*/
                                        ...
                                        foreach (TYPE_STORE as $typeId => $itemType) {
                                            ...
                                            <div class="opt_offer_item opt_offer_item_js">
                                                <div class="minus <?= $store["PRODUCT_AMOUNT"] != 0 ? "minus_js" : "minus_pa"; ?>">
                                                    -
                                                </div>

                                                <input type="number"
                                                       value="<?= $arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY'] ?>"
                                                       name="CNT"
                                                       data-del-id="<?= $arResult['ELEMENTS'][$key_off][$typeId]['ID'] ?>"
                                                       data-id="<?= $key_off ?>" data-store="<?= $typeId ?>"
                                                       class="basket_store_quantity inoffer_js in_number_js <?= $arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY'] > 0 ? "color_change" : ""; ?> <?= $amount == 0 ? "basket_store_quantity_pa" : ""; ?>"
                                                       max="<?= $amount ?>"
                                                       placeholder="<?= $amount >= 10 ? ">10" : $amount; ?>" <?= $amount == 0 ? "readonly" : ""; ?>>

                                                <div class="plus <?= $amount != 0 ? "plus_js" : "plus_pa"; ?>">+</div>
                                            </div>
                                            <?
                                            $full_summ_offer += floatval($arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY']) * floatval($arResult['ELEMENTS'][$off['ID']][$typeId]['PRICE']);
                                            $full_quantity_offer += floatval($arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY']);
                                            $final_price += floatval($arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY']) * floatval($arResult['ELEMENTS'][$typeId][$store['ID']]['PRICE']);
                                            $final_quantity += floatval($arResult['ELEMENTS'][$off['ID']][$typeId]['QUANTITY']);
                                            ?>
                                ...
                                <div class="all_param_item all_param_item_store">
                                    ...
                                    foreach (TYPE_STORE as $typeId => $itemType) {
                                        ...
                                        <div class="sklad_info">
                                            <div class="itogo">
                                                Итого (без скидок): <br><span
                                                        class="srote_info_item_price<?= $typeId ?>">0 руб.</span><br>
                                                Итого (шт): <span
                                                        class="srote_info_item_quantity<?= $typeId ?>">0</span>
                                            </div>
                                        </div>
                                    <? } ?>
                                </div>
                            ...
                            <div style="width: 100%;    display: inline-block;">
                                <div class="delete_all_item basket__delete_opt_js" data-action="delete"
                                     data-id="<?= $arResult['MAIN_ITEM'][$key1]['ID'] ?>">
                                    Удалить из заказа
                                </div>
                            </div>
                            <div class="top_item_name">
                                <div class="itogo">
                                    Итого по всем складам: <span class="current_price_js"
                                                                 data-price="<?= $arResult['OfferPrice95'][$key1] ?>"><?= number_format($full_summ_offer, 0, ' ', ' ') ?></span>
                                    руб.<br>
                                    Итого (шт) по всем складам: <span
                                            class="count_opt_js"><?= $full_quantity_offer ?></span>
                                </div>
                            </div>
                        </div>
                    <? } ?>
                    <div class="all_summ">
                        <div class="info_store_left">
                            <div class="top_item_name">
                                <div class="itogo">
                                    Итого по всем складам: <span
                                            class="full_price_js"><?= number_format($final_price, 0, ' ', ' ') ?></span>
                                    руб.<br>
                                    Итого (шт) по всем складам: <span
                                            class="full_quantity_js"><?= $final_quantity ?></span>
                                </div>
                            </div>
                        </div>
                                ...
                                foreach (TYPE_STORE as $typeId => $itemType) {
                                    ...
                                    <div class="sklad_info">
                                        <div class="itogo">
                                            ...
                                            Итого (шт): <span
                                                    class="all_srote_info_item_quantity<?= $typeId ?>">0</span>
                        ...
                        <form class="opt_order_ajax">
                            ...
                            <div id="order_form_content_opt">
                                ...
                                <input type="hidden" name="NAME"
                                       value="<?= $arParams['USER']['NAME'] ? mb_substr($arParams['USER']['NAME'], 0, 1) . "." : ""; ?><?= $arParams['USER']['SECOND_NAME'] ? mb_substr($arParams['USER']['SECOND_NAME'], 0, 1) . "." : ""; ?><?= $arParams['USER']['LAST_NAME'] ? $arParams['USER']['LAST_NAME'] : ""; ?>">
                                ...
                                <div class="basket__names_opt">
                                    <div class="lk_show_block">
                                        Заказ
                                        от: <?= $arParams['USER']['NAME'] ? mb_substr($arParams['USER']['NAME'], 0, 1) . "." : ""; ?><?= $arParams['USER']['SECOND_NAME'] ? mb_substr($arParams['USER']['SECOND_NAME'], 0, 1) . "." : ""; ?><?= $arParams['USER']['LAST_NAME'] ? $arParams['USER']['LAST_NAME'] : ""; ?>
                                    </div>
                                    <div class="names__item basket__register">
                                        <label class="names__label basket__label">
                                            <textarea name="COMMENT" id="comment" placeholder="Комментарий к заказу"
                                                      class="basket__comment"></textarea>
                                            Комментарий
                                        </label>
                                    ...
                                    <div class="basket__info-rules">Завершая оформление заказа, я соглашаюсь с <a
                                                href="/privacy_policy/" class="basket__info-rules-link">правилами
                                            обработки информации.</a></div>
                                </div>
                                <div class="bx_ordercart basket__info-wrapper_opt">
                                    <div class="basket__info_OPT ">
                                        ...
                                        <div class="basket__info-item">
                                            ...
                                            <span class="basket__info-price tq_total "><span
                                                        class="full_price_js"><?= number_format($final_price, 0, ' ', ' ') ?></span> руб.</span>
                                        </div>
                                        <?
                                        ...
                                        if ($_GET['PROMO'] != '') {
                                            $pres = CIBlockElement::GetList([], [
                                                ...
                                                "ACTIVE_DATE" => "Y",
                                                "ACTIVE" => "Y",
                                                "PROPERTY_PROMO_CODE" => $_GET['PROMO']
                                            ], false, [], [
                                                "ID",
                                                "IBLOCK_ID",
                                                "NAME",
                                                "PROPERTY_PROMO_CODE",
                                                "PROPERTY_COUNT",
                                                "PROPERTY_DISCOUNT_PROC",
                                                "PROPERTY_DISCOUNT_FIX"
                                            ]);
		...
		<span class="from_sale_price_js"><?= number_format(round($final_price - calc_percent($final_price, $curent_discount_percend)), 0, ' ', ' ') ?></span> руб.
                                        ...
                                        <div class="basket__info-item">
                                            ...
                                            <input type="hidden" name="FULL_PERCEND" class="full_percend_order"
                                                   value="<?= $curent_discount_percend + $Discount + $first_discount ?>">
                                            <input type="hidden" name="SALE_PERCEND" class="sale_percend_order"
                                                   value="<?= $curent_discount_percend ?>">

                                            <input type="hidden" name="SUMMA_PREDOPLATU" class="summa_predoplatu_order"
                                                   value="<?= number_format(round($final_price - calc_percent($final_price, $curent_discount_percend)), 0, ' ', ' ') ?> .руб">
                ...
                <table class="sale_order_full_table_opt">
                    ...
                    <tr>
                        <td>
                            ...
                            Ваш заказ <b>№<?= $arOrder['ID'] ?></b>
                            от <?= FormatDate("d F Y", strtotime($arOrder['DATE_INSERT'])) ?> успешно создан.
                            <br><br>
